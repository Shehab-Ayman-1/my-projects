...
export const DetailsHeader = ({ artistId, artistData, songData }) => {
	const imageSrc = artistId ? artistData?.attributes?.artwork?.url.replace("{w}", "500").replace("{h}", "500") : songData?.images?.coverart;
	...
	return (
		<div className="relative w-full flex flex-col">
			...
			<div className="absolute inset-0 flex items-center">
				<img src={imageSrc} alt="profile" className="sm:w-48 w-28 sm:h-48 h-28 rounded-full object-cover border-2 shadow-xl shadow-black" />
