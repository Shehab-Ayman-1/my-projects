...
import { setActiveSong, playPause, useGetSongDetailsQuery, useGetSongRelatedQuery } from "@/redux";
...
export const SongDetails = () => {
	...
	return (
		<div className="flex flex-col">
			...
			<RelatedSongs data={data} artistId={artistId} isPlaying={isPlaying} activeSong={activeSong} handlePauseClick={handlePauseClick} handlePlayClick={handlePlayClick} />
		</div>
	);
};
