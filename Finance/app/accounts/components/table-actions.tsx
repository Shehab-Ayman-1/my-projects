...
import { useEditModel } from "@/features/accounts/hooks/useEditModel";
...
export const Actions = ({ _id, name }: ActionsProps) => {
    const [ConfirmDialog, confirm] = useConfirm(
        "Are You Sure?",
        "You Are About To Delete This Account, And unable To Undo It Again",
    );
        ...
        <Fragment>
            ...
            <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                    <DropdownMenuItem
                        disabled={false}
                        onClick={() => onOpen({ accountId: _id, name })}
