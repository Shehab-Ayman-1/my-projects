...
import { useContext, setOpenConfigurator, setOpenSidenav } from "@/context";
import { logoSpotify, team2 } from "@/assets";
               ...
               <Menu>
                  ...
                  <MenuList className="w-max border-0">
                     <MenuItem className="flex items-center gap-3">
                        <Avatar src={team2} alt="item-2" size="sm" variant="circular" />
                        <div>
                     ...
                     <MenuItem className="flex items-center gap-4">
                        <Avatar src={logoSpotify} alt="logoSpotify" size="sm" variant="circular" />
                        <div>
                           <Typography variant="small" color="blue-gray" className="mb-1 font-normal">
